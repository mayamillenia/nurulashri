	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="<?php echo base_url('saveAccount')?>" >
					<div class="text-center">
						<img class="avatar" src="<?php echo base_url('assets/images/icon/mosque.png')?>">
					</div>
					<span style="text-align: center;">
						Create New An Account Admin
					</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid username is: a@b.c">
						<input class="input100" type="text" name="lname" autofocus>
