...
<!-- Favicon-->
<link rel="shortcut icon" href="assets/frontend/css/img/fav.png">
<!-- Author Meta -->
...
<div class="row">
	<div class="col-lg-6 col-sm-6 col-4 header-top-left no-padding">
		<ul>
			<li><a title="Nurul Ashri" href="#"><i class="fa fa-facebook"></i></a></li>
			<li><a title="Nurul Ashri" href="#"><i class="fa fa-twitter"></i></a></li>
			<li><a title="Nurul Ashri" href="#"><i class="fa fa-dribbble"></i></a></li>
			<li><a title="Nurul Ashri" href="#"><i class="fa fa-youtube"></i></a></li>
		</ul>
	</div>
</div>			  					
</div>
...
<div id="logo">
	<a href="<?php echo base_url('NurulAshri')?>"><img src="<?php echo base_url('assets/images/icon/mosque4.png')?>" style="width: 7%" /></a>
</div>
<nav id="nav-menu-container">
	<ul class="nav-menu">
		...
		<li><a href="">Blog</a></li>
		<li class="menu-has-children"><a href="">null</a>
			<ul>
				<li><a href=""></a>null</li>
				<li><a href="">null</a></li>
			</ul>
...
<div class="banner-content col-lg-7 col-md-6 justify-content-center ">
	<h6 class="text-uppercase">Masjid Nurul Ashri</h6>
	<h1>
		Semua kajian ada di sini			
	</h1>
	<p class="text-white">
		Kajian rutin setiap hari senin - minggu pukul 16:00 WIB
		Dan kajian khusus akhwat setiap hari kamis.
	</p>
</div>	
<div class="banner-img col-lg-5 col-md-6 align-self-end">
	<img class="img-fluid" src="<?php echo base_url('assets/images/icon/mosque4.png')?>" alt="">
</div>											
</div>
</div>
</section>
...
<div class="col-md-12 pb-50 header-text text-center">
	<h1 class="mb-10">Info Kajian Minggu Ini</h1>
	<p>
		Kajian di upload tiap jam 09.00 WIB
	</p>
</div>
</div>						
<div class="row">
	<?php foreach ($nurash as $n) { ?>
		<div class="col-lg-3 col-md-6">
			<div class="single-service">
				<div class="thumb">
					<img src="<?php echo base_url('assets/images/kajian/').$n['image_kajian']?>" alt="">	
				</div>
				<div style="margin: 5px">
					<h4><?php echo $n['judul_kajian']?></h4>
				</div>
				<div style="margin: 5px">
					<p><?php echo substr($n['deskripsi_kajian'], 0,400) ?><span class="read_more" style="display: none"><?php echo substr($n['deskripsi_kajian'], 400,1000)?></span>
					</p>
					<a class="clickReadmore" onclick="readMore($(this));">Read More ...</a>
					<a class="clickReadless" style="display: none">Read Less ...</a>
				</div>
			</div>
		</div>
	<?php  } ?>
...
<div class="work-arrow">
	<img src="assets/frontend/img/arrow.png" alt="">
</div>
<div class="single-work-process">
	<div class="work-icon-box">
...
<div class="row">
	<div class="active-testimonial-carusel">
		<div class="single-testimonial item">
			<img class="mx-auto" src="assets/frontend/img/t1.png" alt="">
			<p class="desc">
		...
		<div class="single-testimonial item">
			<img class="mx-auto" src="assets/frontend/img/t2.png" alt="">
			<p class="desc">
				Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
			</p>
			<h5>Mark Alviro Wiens</h5>
		...
		<div class="single-testimonial item">
			<img class="mx-auto" src="assets/frontend/img/t3.png" alt="">
			<p class="desc">
				Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
			</p>
			<h5>Mark Alviro Wiens</h5>
...
<div class="row">
	<div class="col-lg-3 col-md-6 single-blog">
		<div class="thumb">
			<img class="img-fluid" src="assets/frontend/img/b1.jpg" alt="">								
		</div>
	...
	<div class="col-lg-3 col-md-6 single-blog">
		<div class="thumb">
			<img class="img-fluid" src="assets/frontend/img/b2.jpg" alt="">								
		</div>
		<p class="meta">25 October, 2017  |  By <a href="#">Mark Wiens</a></p>
		<a href="">
	...
	<div class="col-lg-3 col-md-6 single-blog">
		<div class="thumb">
			<img class="img-fluid" src="assets/frontend/" alt="">								
		</div>
		<p class="meta">25 October, 2017  |  By <a href="#">Mark Wiens</a></p>
		<a href="l">
	...
	<div class="col-lg-3 col-md-6 single-blog">
		<div class="thumb">
			<img class="img-fluid" src="assets/frontend/img/b4.jpg" alt="">								
		</div>
		<p class="meta">25 October, 2017  |  By <a href="#">Mark Wiens</a></p>
...
<div class="brand-wrap">
	<div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
		<div class="col single-brand">
			<a href="#"><img class="mx-auto" src="assets/frontend/img/l1.png" alt=""></a>
		</div>
		<div class="col single-brand">
			<a href="#"><img class="mx-auto" src="assets/frontend/img/l2.png" alt=""></a>
		</div>
		<div class="col single-brand">
			<a href="#"><img class="mx-auto" src="assets/frontend/img/l3.png" alt=""></a>
		</div>
		<div class="col single-brand">
			<a href="#"><img class="mx-auto" src="assets/frontend/img/l4.png" alt=""></a>
		</div>
		<div class="col single-brand">
			<a href="#"><img class="mx-auto" src="assets/frontend/img/l5.png" alt=""></a>
		</div>								
	</div>																			
</div>
</div>	
...
<script src="<?php echo base_url('assets/frontend/https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js')?>"></script>
<script src="<?php echo base_url('assets/frontend/js/vendor/bootstrap.min.js') ?>"></script>			
<!-- <script type="text/javascript" src="assets/frontend/https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script> -->
...
<script src="<?php echo base_url('assets/frontend/js/mn-accordion.js')?>"></script>
...
<script src="<?php echo base_url('assets/frontend/js/jquery.circlechart.js')?>"></script>								
<script src="<?php echo base_url('assets/frontend/js/mail-script.js')?>"></script>	
<script src="<?php echo base_url('assets/frontend/js/main.js')?>"></script>	
<script src="<?php echo base_url('assets/frontend/js/customjs/customNS.js')?>"></script>	
</body>
</html>